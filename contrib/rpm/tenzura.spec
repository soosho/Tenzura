...
License:	MIT
URL:		https://tenzura.org/
Source0:	https://tenzura.org/bin/tenzura-core-%{version}/tenzura-%{version}.tar.gz
...
%{_sbindir}/semanage port -a -t tenzura_port_t -p tcp 8766
%{_sbindir}/semanage port -a -t tenzura_port_t -p tcp 8767
