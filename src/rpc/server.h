...
#ifndef TENZURA_RPCSERVER_H
#define TENZURA_RPCSERVER_H
...
/**
 * Tenzura RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isTENZ = true);
