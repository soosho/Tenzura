...
#ifndef TENZURA_TEST_SCRIPTNUM10_H
#define TENZURA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Tenzura Core 0.10.0, for cross-comparison.
 */
public:
