...
BOOST_FIXTURE_TEST_SUITE(asset_tx_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_multiple_assets_test)
    {
        ...
        // The inputs are spending 3000 Assets (1000 of each TENZURA, RAVENTEST, RAVENTESTTEST)
        // The outputs are spending 100 Assets to 10 destinations (10 * 100 = 1000) (of each TENZURA, RAVENTEST, RAVENTESTTEST)
