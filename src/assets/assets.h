...
#ifndef TENZURA_ASSET_PROTOCOL_H
#define TENZURA_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_TENZURA_ASSET TENZQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_TENZURA_ASSET TENZO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_TENZURA_ASSET TENZR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_TENZURA_ASSET TENZT
...
#endif //TENZURA_ASSET_PROTOCOL_H
