...
#ifndef TENZURA_QT_SENDASSETSENTRY_H
#define TENZURA_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending tenzuras.
...
#endif // TENZURA_QT_SENDASSETSENTRY_H
