...
#ifndef TENZURA_QT_OPTIONSMODEL_H
#define TENZURA_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Tenzura client.
...
#endif // TENZURA_QT_OPTIONSMODEL_H
