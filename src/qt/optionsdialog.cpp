    ...
    mapper(0)
{
    ...
    ui->tenzuraAtStartup->setToolTip(ui->tenzuraAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->tenzuraAtStartup->setText(ui->tenzuraAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openTenzuraConfButton->setToolTip(ui->openTenzuraConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new TenzuraUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->tenzuraAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTenzuraConfButton_clicked()
{
