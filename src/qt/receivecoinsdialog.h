...
#ifndef TENZURA_QT_RECEIVECOINSDIALOG_H
#define TENZURA_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of tenzuras */
...
#endif // TENZURA_QT_RECEIVECOINSDIALOG_H
