...
#include "qt/tenzuraamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<TenzuraAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_tenzura-qt -platform xcb      # Linux
//     src/qt/test/test_tenzura-qt -platform windows  # Windows
//     src/qt/test/test_tenzura-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = TenzuraUnits::formatWithUnit(unit, balance, false, TenzuraUnits::separatorAlways);
    ...
    // Amount input
    TenzuraAmountField* amountInput = receiveCoinsDialog.findChild<TenzuraAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: tenzura:")) != -1);
