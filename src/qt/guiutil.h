...
#ifndef TENZURA_QT_GUIUTIL_H
#define TENZURA_QT_GUIUTIL_H
...
/** Utility functions used by the Tenzura Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "tenzura:" URI into recipient object, return true on successful parsing
