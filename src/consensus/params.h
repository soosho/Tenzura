...
#ifndef TENZURA_CONSENSUS_PARAMS_H
#define TENZURA_CONSENSUS_PARAMS_H
...
namespace Consensus {
    ...
    struct Params {
        ...
        /** DevFee parameters */
        CScript devFeeScript;  // Developer fee script pubkey
        int devFeePercent;     // Developer fee percentage (5% = 5)
    };
    } // namespace Consensus

#endif // TENZURA_CONSENSUS_PARAMS_H