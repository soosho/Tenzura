 ...
 */
#ifndef TENZURA_UTIL_H
#define TENZURA_UTIL_H
...
extern const char *const TENZURA_CONF_FILENAME;
extern const char *const TENZURA_PID_FILENAME;
...
{
    std::string s = strprintf("tenzura-%s", name);
