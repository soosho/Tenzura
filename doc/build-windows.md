...
Below are some notes on how to build Tenzura Core for Windows.
...
way. This will install to `c:\workspace\tenzura`, for example:

    make install DESTDIR=/mnt/c/workspace/tenzura
