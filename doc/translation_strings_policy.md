...
This document provides guidelines for internationalization of the Tenzura Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tenzura_en.ts` remains unchanged.
