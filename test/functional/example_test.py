...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TenzuraTestFramework
    pass

class ExampleTest(TenzuraTestFramework):
    # Each functional test is a subclass of the TenzuraTestFramework class.
    ...
    def custom_method(self):
        ...
        TenzuraTestFramework class so other tests can use it."""
