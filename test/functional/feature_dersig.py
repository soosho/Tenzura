...
class BIP66Test(TenzuraTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # tenzurad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and tenzurad produces more specific reject
            # reasons.
