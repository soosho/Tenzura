...
# TestNode: A peer we use to send messages to tenzurad, and store responses.
...
class CompactBlocksTest(TenzuraTestFramework):
    ...
    # This test actually causes tenzurad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that tenzurad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for tenzurad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # tenzurad will not send blocktxn responses for blocks whose height is
