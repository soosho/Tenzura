...
class TestTenzuraCli(TenzuraTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `tenzura-cli getinfo`")
        ...
        self.log.info("Compare responses from `tenzura-cli -getinfo` and the RPCs data is retrieved from.")
