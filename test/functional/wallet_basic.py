...
class WalletTest(TenzuraTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 TENZ from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 TENZ with subtract fee from amount
        ...
        # Sendmany 10 TENZ with subtract fee from amount
