...
class TxnMallTest(TenzuraTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 TENZ:
        ...
        # First: use raw transaction API to send 1240 TENZ to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 TENZ coin each
        ...
        # Node0's balance should be starting balance, plus 50TENZ for another
        ...
        # Node0's total balance should be starting balance, plus 100TENZ for 
