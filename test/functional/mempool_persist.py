...
By default, tenzurad will dump mempool on shutdown and
...
class MempoolPersistTest(TenzuraTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give tenzurad a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent tenzurad from writing mempool.dat to disk. Verify that `savemempool` fails")
